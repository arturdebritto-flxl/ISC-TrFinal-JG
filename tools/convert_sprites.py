...
def build_runtime_sprites() -> dict[str, tuple[str, str, int]]:
    ...
    sprites: dict[str, tuple[str, str, int]] = {
        ...
        "sprite_enemy_spitter_down_0": (FINAL_GROUP, "03_INIMIGOS/rat_spitter_16x16/frames/down__walk_1.png", 16),
        "sprite_enemy_spitter_down_1": (FINAL_GROUP, "03_INIMIGOS/rat_spitter_16x16/frames/down__walk_2.png", 16),
        "sprite_enemy_spitter_up_0": (FINAL_GROUP, "03_INIMIGOS/rat_spitter_16x16/frames/up__walk_1.png", 16),
        "sprite_enemy_spitter_up_1": (FINAL_GROUP, "03_INIMIGOS/rat_spitter_16x16/frames/up__walk_2.png", 16),
        "sprite_enemy_spitter_right_0": (FINAL_GROUP, "03_INIMIGOS/rat_spitter_16x16/frames/right__walk_1.png", 16),
    ...
    static = {
        ...
        "sprite_projectile_spitter": ("06_PROJETEIS/projectile_spitter_5x5.png", 5),
        "sprite_projectile_boss": ("06_PROJETEIS/projectile_boss_green_7x7.png", 7),
    }
